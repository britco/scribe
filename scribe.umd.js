...
(function () {
    ...
    */
    ...
    if (true) {
        amdclean['event_emitter'] = function () {
            return EventEmitter;
        }();
        ...
        this.EventEmitter = EventEmitter;
                   ...
                   */
amdclean['lodash_modern_internals_isNative'] = function () {
...
amdclean['lodash_modern_internals_objectTypes'] = function () {
...
amdclean['lodash_modern_objects_isObject'] = function (objectTypes) {
    /**
    ...
    return isObject;
}(amdclean['lodash_modern_internals_objectTypes']);
amdclean['lodash_modern_internals_shimKeys'] = function (objectTypes) {
    /** Used for native method references */
    var objectProto = Object.prototype;
...
amdclean['lodash_modern_objects_keys'] = function (isNative, isObject, shimKeys) {
    ...
    return keys;
}(amdclean['lodash_modern_internals_isNative'], amdclean['lodash_modern_objects_isObject'], amdclean['lodash_modern_internals_shimKeys']);
amdclean['lodash_modern_objects_defaults'] = function (keys, objectTypes) {
    /**
    ...
    return defaults;
}(amdclean['lodash_modern_objects_keys'], amdclean['lodash_modern_internals_objectTypes']);
amdclean['plugins_core_commands_indent'] = function () {
...
amdclean['lodash_modern_utilities_noop'] = function () {
    /**
...
amdclean['lodash_modern_internals_baseCreate'] = function (isNative, isObject, noop) {
    /* Native method shortcuts for methods with the same name as other `lodash` methods */
    ...
    return baseCreate;
}(amdclean['lodash_modern_internals_isNative'], amdclean['lodash_modern_objects_isObject'], amdclean['lodash_modern_utilities_noop']);
amdclean['lodash_modern_internals_setBindData'] = function (isNative, noop) {
    ...
    return setBindData;
}(amdclean['lodash_modern_internals_isNative'], amdclean['lodash_modern_utilities_noop']);
amdclean['lodash_modern_internals_slice'] = function () {
    /**
...
amdclean['lodash_modern_internals_baseBind'] = function (baseCreate, isObject, setBindData, slice) {
    /**
    ...
    return baseBind;
}(amdclean['lodash_modern_internals_baseCreate'], amdclean['lodash_modern_objects_isObject'], amdclean['lodash_modern_internals_setBindData'], amdclean['lodash_modern_internals_slice']);
amdclean['lodash_modern_internals_baseCreateWrapper'] = function (baseCreate, isObject, setBindData, slice) {
    /**
     * Used for `Array` method references.
     *
     * Normally `Array.prototype` would suffice, however, using an array literal
...
amdclean['lodash_modern_objects_isFunction'] = function () {
    /**
...
amdclean['lodash_modern_internals_createWrapper'] = function (baseBind, baseCreateWrapper, isFunction, slice) {
    /**
     * Used for `Array` method references.
     *
     * Normally `Array.prototype` would suffice, however, using an array literal
...
}(amdclean['lodash_modern_internals_baseBind'], amdclean['lodash_modern_internals_baseCreateWrapper'], amdclean['lodash_modern_objects_isFunction'], amdclean['lodash_modern_internals_slice']);
amdclean['lodash_modern_functions_bind'] = function (createWrapper, slice) {
    /**
    ...
    return bind;
}(amdclean['lodash_modern_internals_createWrapper'], amdclean['lodash_modern_internals_slice']);
amdclean['lodash_modern_utilities_identity'] = function () {
    /**
...
amdclean['lodash_modern_support'] = function (isNative) {
    ...
    return support;
}(amdclean['lodash_modern_internals_isNative']);
amdclean['lodash_modern_internals_baseCreateCallback'] = function (bind, identity, setBindData, support) {
...
}(amdclean['lodash_modern_functions_bind'], amdclean['lodash_modern_utilities_identity'], amdclean['lodash_modern_internals_setBindData'], amdclean['lodash_modern_support']);
amdclean['lodash_modern_objects_forIn'] = function (baseCreateCallback, objectTypes) {
    /**
    ...
    return forIn;
}(amdclean['lodash_modern_internals_baseCreateCallback'], amdclean['lodash_modern_internals_objectTypes']);
amdclean['lodash_modern_internals_arrayPool'] = function () {
    /** Used to pool arrays and objects used internally */
    var arrayPool = [];
    return arrayPool;
}();
amdclean['lodash_modern_internals_getArray'] = function (arrayPool) {
    /**
    ...
    return getArray;
}(amdclean['lodash_modern_internals_arrayPool']);
amdclean['lodash_modern_internals_maxPoolSize'] = function () {
    /** Used as the max size of the `arrayPool` and `objectPool` */
    var maxPoolSize = 40;
    return maxPoolSize;
}();
amdclean['lodash_modern_internals_releaseArray'] = function (arrayPool, maxPoolSize) {
    /**
    ...
    return releaseArray;
}(amdclean['lodash_modern_internals_arrayPool'], amdclean['lodash_modern_internals_maxPoolSize']);
amdclean['lodash_modern_internals_baseIsEqual'] = function (forIn, getArray, isFunction, objectTypes, releaseArray) {
    ...
    return baseIsEqual;
}(amdclean['lodash_modern_objects_forIn'], amdclean['lodash_modern_internals_getArray'], amdclean['lodash_modern_objects_isFunction'], amdclean['lodash_modern_internals_objectTypes'], amdclean['lodash_modern_internals_releaseArray']);
amdclean['lodash_modern_utilities_property'] = function () {
    /**
...
amdclean['lodash_modern_functions_createCallback'] = function (baseCreateCallback, baseIsEqual, isObject, keys, property) {
    /**
...
}(amdclean['lodash_modern_internals_baseCreateCallback'], amdclean['lodash_modern_internals_baseIsEqual'], amdclean['lodash_modern_objects_isObject'], amdclean['lodash_modern_objects_keys'], amdclean['lodash_modern_utilities_property']);
amdclean['lodash_modern_arrays_last'] = function (createCallback, slice) {
    ...
    return last;
}(amdclean['lodash_modern_functions_createCallback'], amdclean['lodash_modern_internals_slice']);
amdclean['lodash_modern_internals_baseIndexOf'] = function () {
    /**
...
amdclean['lodash_modern_objects_forOwn'] = function (baseCreateCallback, keys, objectTypes) {
    /**
    ...
    return forOwn;
}(amdclean['lodash_modern_internals_baseCreateCallback'], amdclean['lodash_modern_objects_keys'], amdclean['lodash_modern_internals_objectTypes']);
amdclean['lodash_modern_objects_isArray'] = function (isNative) {
    /** `Object#toString` result shortcuts */
...
amdclean['lodash_modern_objects_isString'] = function () {
    /** `Object#toString` result shortcuts */
...
amdclean['lodash_modern_collections_contains'] = function (baseIndexOf, forOwn, isArray, isString) {
    /* Native method shortcuts for methods with the same name as other `lodash` methods */
    var nativeMax = Math.max;
    /**
    ...
    return contains;
}(amdclean['lodash_modern_internals_baseIndexOf'], amdclean['lodash_modern_objects_forOwn'], amdclean['lodash_modern_objects_isArray'], amdclean['lodash_modern_objects_isString']);
amdclean['plugins_core_commands_insert_html'] = function (last, contains) {
    return function () {
        return function (scribe) {
            // TODO: not exhaustive?
...
}(amdclean['lodash_modern_arrays_last'], amdclean['lodash_modern_collections_contains']);
amdclean['plugins_core_commands_insert_list'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_commands_outdent'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_commands_redo'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_commands_undo'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_commands'] = function (indent, insertHTML, insertList, outdent, redo, undo) {
    return {
        indent: indent,
...
}(amdclean['plugins_core_commands_indent'], amdclean['plugins_core_commands_insert_html'], amdclean['plugins_core_commands_insert_list'], amdclean['plugins_core_commands_outdent'], amdclean['plugins_core_commands_redo'], amdclean['plugins_core_commands_undo']);
amdclean['plugins_core_events'] = function (contains) {
    return function () {
        return function (scribe) {
            /**
...
}(amdclean['lodash_modern_collections_contains']);
amdclean['plugins_core_formatters_html_replace_nbsp_chars'] = function () {
    return function (scribe) {
        var nbspChar = '&nbsp;|\xA0';
...
amdclean['lodash_modern_internals_htmlEscapes'] = function () {
    /**
...
amdclean['lodash_modern_internals_escapeHtmlChar'] = function (htmlEscapes) {
    /**
...
}(amdclean['lodash_modern_internals_htmlEscapes']);
amdclean['lodash_modern_internals_reUnescapedHtml'] = function (htmlEscapes, keys) {
    /** Used to match HTML entities and HTML characters */
    var reUnescapedHtml = RegExp('[' + keys(htmlEscapes).join('') + ']', 'g');
    return reUnescapedHtml;
}(amdclean['lodash_modern_internals_htmlEscapes'], amdclean['lodash_modern_objects_keys']);
amdclean['lodash_modern_utilities_escape'] = function (escapeHtmlChar, keys, reUnescapedHtml) {
    /**
    ...
    return escape;
}(amdclean['lodash_modern_internals_escapeHtmlChar'], amdclean['lodash_modern_objects_keys'], amdclean['lodash_modern_internals_reUnescapedHtml']);
amdclean['plugins_core_formatters_plain_text_escape_html_characters'] = function (escape) {
    return function () {
        return function (scribe) {
            scribe.plainTextFormatter.formatters.push(escape);
        };
    };
}(amdclean['lodash_modern_utilities_escape']);
amdclean['plugins_core_inline_elements_mode'] = function () {
    // TODO: abstract
...
amdclean['plugins_core_patches_commands_bold'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_patches_commands_indent'] = function () {
    /**
...
amdclean['plugins_core_patches_commands_insert_html'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_patches_commands_insert_list'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_patches_commands_outdent'] = function () {
    return function (scribe) {
...
amdclean['plugins_core_patches_empty_when_deleting'] = function emptyEditorWhenDeleting() {
    return function (scribe) {
...
amdclean['plugins_core_patches_events'] = function () {
    return function (scribe) {
        /**
         * Chrome: If a parent node has a CSS `line-height` when we apply the
...
amdclean['plugins_core_patches'] = function (boldCommand, indentCommand, insertHTMLCommand, insertListCommands, outdentCommand, emptyWhenDeleting, events) {
    /**
...
}(amdclean['plugins_core_patches_commands_bold'], amdclean['plugins_core_patches_commands_indent'], amdclean['plugins_core_patches_commands_insert_html'], amdclean['plugins_core_patches_commands_insert_list'], amdclean['plugins_core_patches_commands_outdent'], amdclean['plugins_core_patches_empty_when_deleting'], amdclean['plugins_core_patches_events']);
amdclean['plugins_core_set_root_p_element'] = function () {
    return function (scribe) {
...
amdclean['api_command_patch'] = function (scribe) {
...
amdclean['api_command'] = function (scribe) {
...
amdclean['api_element'] = function (Node) {
...
amdclean['api_selection'] = function (scribe) {
    function Selection() {
...
amdclean['api_simple_command'] = function (api, scribe) {
...
amdclean['api'] = function (buildCommandPatch, buildCommand, Element, Node, buildSelection, buildSimpleCommand) {
...
}(amdclean['api_command_patch'], amdclean['api_command'], amdclean['api_element'], amdclean['api_node'], amdclean['api_selection'], amdclean['api_simple_command']);
amdclean['lodash_modern_objects_assign'] = function (baseCreateCallback, keys, objectTypes) {
    /**
     * Assigns own enumerable properties of source object(s) to the destination
...
amdclean['transaction_manager'] = function (assign) {
    return function (scribe) {
...
}(amdclean['lodash_modern_objects_assign']);
amdclean['undo_manager'] = function (scribe) {
...
amdclean['scribe'] = function (EventEmitter, defaults, commands, events, replaceNbspCharsFormatter, escapeHtmlCharactersFormatter, inlineElementsMode, patches, setRootPElement, Api, buildTransactionManager, buildUndoManager) {
    ...
    return Scribe;
}(amdclean['event_emitter'], amdclean['lodash_modern_objects_defaults'], amdclean['plugins_core_commands'], amdclean['plugins_core_events'], amdclean['plugins_core_formatters_html_replace_nbsp_chars'], amdclean['plugins_core_formatters_plain_text_escape_html_characters'], amdclean['plugins_core_inline_elements_mode'], amdclean['plugins_core_patches'], amdclean['plugins_core_set_root_p_element'], amdclean['api'], amdclean['transaction_manager'], amdclean['undo_manager']);

module.exports = amdclean.scribe;
//# sourceMappingURL=scribe.umd.js.map