...
(function (root, factory) {
    ...
    function createTreeWalker(node) {
        return document.createTreeWalker(node, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_COMMENT);
    }
    return HTMLJanitor;
}));
modules['scribe_plugin_sanitizer'] = function (HTMLJanitor) {
    /**
